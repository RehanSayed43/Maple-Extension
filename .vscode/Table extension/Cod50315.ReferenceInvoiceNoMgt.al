codeunit 50315 "ReferenceInvoiceNoMgt"
{
    var
    ...
    procedure UpdateReferenceInvoiceNoforVendor(
        ...
        DocumentNo: Code[20]; NOGST: Boolean)
    var
        ...
        if PurchaseHeader.FindFirst() then begin
            ...
            if VendorLedgerEntry.FindFirst() then begin
                ...
                if VendorLedgerEntries.RunModal() = Action::LookupOK then begin
                    ...
                    DetailedGSTLedgerEntry.SetRange("Document Type", GSTDocumentType);
                    //ccit_kj+++
                    if NOT DetailedGSTLedgerEntry.FindFirst() then begin
                       ...
                       then begin
                            ...
                            ReferenceInvoiceNo."Reference Invoice Noss." := VendorLedgerEntry."Document No.";
                            ReferenceInvoiceNo.Verified := true;
                            /*  ReferenceInvoiceNo. */
                        end else
            ...
            if CustomerLedgerEntries.RunModal() = Action::LookupOK then begin
                ...
                if not DetailedGSTLedgerEntry.FindFirst() then begin
                    ...
                    then begin
                        ...
                        ReferenceInvoiceNo."Reference Invoice Noss." := CustLedgerEntry."Document No.";
                        ReferenceInvoiceNo.Verified := true;
