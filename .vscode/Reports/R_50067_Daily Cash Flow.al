report 50067 "Daily Cash Flow"
{
    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            // column(ServifyAppCodeNew; "Sales Invoice Header"."Servify Approval Code")
            // {
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(TradeindeviceIMEIno_SalesInvoiceHeader; "Trade-in device IMEI no.")
            {
            }
            column(TradeinDeviceModelno_SalesInvoiceHeader; "Trade-in Device Model no.")
            {
            }
            column(EUDeductionfees_SalesInvoiceHeader; "EU Deduction fees")
            {
            }
            ...
            //CCIT AN++
            column(UPIAmtNew; UPIAmtNew) { }
            column(UPICrdNoNew; UPICrdNoNew) { }
            column(AxisAmtNew; AxisAmtNew) { }
            column(AMXAmtNew; AMXAmtNew) { }
            column(CashifyAmtNew; CashifyAmtNew) { }
            column(HDFCAmtNew; HDFCAmtNew) { }
            ...
            column(BANKAppCode5; BANKAppCode5)
            {
            }
            ...
            begin
                ...
                //REHAN
                // "Sales Invoice Header".SetCurrentKey("Posting Date", "Bill-to Customer No.");
                ...
                IF "Sales Invoice Header".PayByCreditNo1 = 'HDFC_CR' THEN BEGIN
                    ...
                    HDFCAmtNew += "Sales Invoice Header".PayByCreditAmt1;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo2 = 'HDFC_CR' THEN BEGIN
                    ...
                    HDFCAmtNew += "Sales Invoice Header".PayByCreditAmt2;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo3 = 'HDFC_CR' THEN BEGIN
                    ...
                    HDFCAmtNew += "Sales Invoice Header".PayByCreditAmt3;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo4 = 'HDFC_CR' THEN BEGIN
                    ...
                    HDFCAmtNew += "Sales Invoice Header".PayByCreditAmt4;
                END;

                IF "Sales Invoice Header".PayByDebitCdNo1 = 'HDFC_DR' THEN BEGIN
                    IF HDFCCardNo <> '' THEN
                        HDFCCardNo += ',';
                    ...
                    HDFCAmtNew += "Sales Invoice Header".PayByDebitCdAmt1;
                END;


                IF "Sales Invoice Header".PayByDebitNo2 = 'HDFC_DR' THEN BEGIN
                    IF HDFCCardNo <> '' THEN
                        HDFCCardNo += ',';

                    HDFCCardNo := "Sales Invoice Header".DebitCardNo2;
                    HDFCAMT += "Sales Invoice Header".PayByDebitAmt2;
                    HDFCAmtNew += "Sales Invoice Header".PayByDebitAmt2;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo1 = 'AXIS_CR' THEN BEGIN
                    ...
                    AxisAmtNew += "Sales Invoice Header".PayByCreditAmt1;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo2 = 'AXIS_CR' THEN BEGIN
                    ...
                    AxisAmtNew += "Sales Invoice Header".PayByCreditAmt2;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo3 = 'AXIS_CR' THEN BEGIN
                    ...
                    AxisAmtNew += "Sales Invoice Header".PayByCreditAmt3;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo4 = 'AXIS_CR' THEN BEGIN
                    ...
                    AxisAmtNew += "Sales Invoice Header".PayByCreditAmt4;
                END;

                IF "Sales Invoice Header".PayByDebitCdNo1 = 'AXIS_DR' THEN BEGIN
                    IF HSBCCardNo <> '' THEN
                        HSBCCardNo += ',';

                    HSBCCardNo += "Sales Invoice Header".DebitCardNo1;
                    HSBCAMT += "Sales Invoice Header".PayByDebitCdAmt1;
                    AxisAmtNew += "Sales Invoice Header".PayByDebitCdAmt1;
                END;

                IF "Sales Invoice Header".PayByDebitNo2 = 'AXIS_DR' THEN BEGIN
                    IF HSBCCardNo <> '' THEN
                        HSBCCardNo += ',';

                    HSBCCardNo += "Sales Invoice Header".DebitCardNo2;
                    HSBCAMT += "Sales Invoice Header".PayByDebitAmt2;
                    AxisAmtNew += "Sales Invoice Header".PayByDebitAmt2;
                END;
                //Message('%1Axis', HSBCAMT);
                //Message('%1AxisNew', AxisAmt);
                Tmpvalue := 0;
                IF ("Sales Invoice Header"."Ref. Invoice No." <> '') AND (PendShieldValue = 0) THEN
                    HSBCAMT := 0
                ELSE BEGIN
                ...
                IF "Sales Invoice Header".PayByCreditNo1 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".CreditCardNo1;
                    UPIAmtNew += "Sales Invoice Header".PayByCreditAmt1;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo2 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".CreditCardNo2;
                    UPIAmtNew += "Sales Invoice Header".PayByCreditAmt2;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo3 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".CreditCardNo3;
                    UPIAmtNew += "Sales Invoice Header".PayByCreditAmt3;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo4 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".CreditCardNo4;
                    UPIAmtNew += "Sales Invoice Header".PayByCreditAmt4;
                END;
                ...
                IF "Sales Invoice Header".PayByDebitCdNo1 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".DebitCardNo1;
                    UPIAmtNew += "Sales Invoice Header".PayByDebitCdAmt1;
                END;
                ...
                IF "Sales Invoice Header".PayByDebitNo2 = 'UPI' THEN BEGIN
                    ...
                    UPICrdNoNew += "Sales Invoice Header".DebitCardNo2;
                    UPIAmtNew += "Sales Invoice Header".PayByDebitAmt2;
                END;
                // Message('%1UPI', UPIAmtNew);
                ...
                IF "Sales Invoice Header".PayByCreditNo1 = 'AMEX_CR' THEN BEGIN
                    ...
                    AMXAmtNew += "Sales Invoice Header".PayByCreditAmt1;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo2 = 'AMEX_CR' THEN BEGIN
                    ...
                    AMXAmtNew += "Sales Invoice Header".PayByCreditAmt2;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo3 = 'AMEX_CR' THEN BEGIN
                    ...
                    AMXAmtNew += "Sales Invoice Header".PayByCreditAmt3;
                END;
                ...
                IF "Sales Invoice Header".PayByCreditNo4 = 'AMEX_CR' THEN BEGIN
                    ...
                    AMXAmtNew += "Sales Invoice Header".PayByCreditAmt4;
                END;

                IF "Sales Invoice Header".PayByDebitCdNo1 = 'AMEX_DR' THEN BEGIN
                    IF AMXCardNo <> '' THEN
                        AMXCardNo += ',';

                    AMXCardNo += "Sales Invoice Header".DebitCardNo1;
                    AMXAMT += "Sales Invoice Header".PayByDebitCdAmt1;
                    AMXAmtNew += "Sales Invoice Header".PayByDebitCdAmt1;
                END;

                IF "Sales Invoice Header".PayByDebitNo2 = 'AMEX_DR' THEN BEGIN
                    IF AMXCardNo <> '' THEN
                        AMXCardNo += ',';

                    AMXCardNo += "Sales Invoice Header".DebitCardNo2;
                    AMXAMT += "Sales Invoice Header".PayByDebitAmt2;
                    AMXAmtNew += "Sales Invoice Header".PayByDebitAmt2;
                END;
                Tmpvalue := 0;
                IF ("Sales Invoice Header"."Ref. Invoice No." <> '') AND (PendShieldValue = 0) THEN
                    AMXAMT := 0
                ...
                IF "Sales Invoice Header"."Ref. Invoice No." = '' THEN BEGIN
                    ...
                    IF "Sales Invoice Header"."Finance Comapny new" <> "Sales Invoice Header"."Finance Comapny new"::" " THEN BEGIN
                        ...
                        END
                        //Rushab_CCit++  Added Idfc
                        ELSE
                            POS1 := 0;
                        POS1 := STRPOS(FORMAT("Sales Invoice Header"."Finance Comapny new"), '5');
                        IF POS1 > 0 THEN BEGIN
                            FinanceCompanyName1 := FORMAT("Sales Invoice Header"."Finance Comapny new");
                            //  FinAmt5:= "Sales Invoice Header"."Finance Amount";
                            IF "Sales Invoice Header"."Bank Approval Code" <> '' THEN
                                BANKAppCode5 := "Sales Invoice Header"."Bank Approval Code";
                            //test++
                            Tmpvalue := 0;
                            FinAmt5 := "Sales Invoice Header"."Finance Amount";
                            IF ("Sales Invoice Header"."Ref. Invoice No." <> '') AND (PendShieldValue = 0) THEN
                                ...
                                IF ("Sales Invoice Header"."Finance Amount" <> 0) AND (PendShieldValue > 0) THEN BEGIN
                                    IF "Sales Invoice Header"."Finance Amount" > PendShieldValue THEN BEGIN
                                        IF "Sales Invoice Header"."Ref. Invoice No." <> '' THEN BEGIN
                                            Tmpvalue := PendShieldValue;
                                            PendShieldValue := 0;
                                            FinAmt5 := PendShieldValue;
                                        END
                                        ELSE BEGIN
                                            Tmpvalue := PendShieldValue;
                                            PendShieldValue := 0;
                                            FinAmt5 := "Sales Invoice Header"."Finance Amount" - Tmpvalue;
                                        END;
                                    END
                                    ELSE BEGIN
                                        IF "Sales Invoice Header"."Ref. Invoice No." <> '' THEN BEGIN
                ...
                */
                ...
                CLEAR(paytm_amount);
                GLEntry.RESET;
                GLEntry.SetCurrentKey("G/L Account No.", "Document No.", "Document Type");
                ...
                //REHAN
                SalesOrderExtension.SetCurrentKey("No.");
                ...
                END;
                //Rushab_CCIT++
                // ServifyAppCodeNew := "Sales Invoice Header"."Servify Approval Code";
                ...
                PendShieldValue := TotShieldvalue;
                Cashify_amount := "Sales Invoice Header"."Cashify Transfer Amount";
                CashifyAmtNew := "Sales Invoice Header"."Cashify Transfer Amount";
                IF ("Sales Invoice Header"."Cashify Transfer Amount" <> 0) AND (PendShieldValue > 0) THEN BEGIN
                    IF "Sales Invoice Header"."Cashify Transfer Amount" > PendShieldValue THEN BEGIN
                        IF "Sales Invoice Header"."Ref. Invoice No." <> '' THEN BEGIN
                            Tmpvalue := PendShieldValue;
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(Location_Codecrr; "Location Code")
            {

            }
            column(Bill_to_Customer_No_crr; "Bill-to Customer No.")
            {
            ...
            begin
                ...
                //REHAN
                //  "Sales Cr.Memo Header".SetCurrentKey("Posting Date", "Bill-to Customer No.");
                Srno1 += 1;
                AppQty1 := 0;
                NonAppQty1 := 0;
                InitVarCrMemo;
    ...
    var
        ...
        UPICrdNoNew: Code[50];
        ICICINewAmt: Decimal;
        ICICICardNoNew: Code[50];
        CashifyAmtNew: Decimal;
        HDFCAmtNew: Decimal;
        ServifyAppCodeNew: Code[50];
