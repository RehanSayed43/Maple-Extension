report 50098 "Inventory Ageing Skuwise"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './InventoryAgeingSkuwise.rdl';
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                begin
                    ...
                    IF PIH.FINDFIRST THEN BEGIN
                        CompAge := TODAY - PIH."Posting Date";
                    END;
                    ...
                    IF CompAge = 0 THEN BEGIN
                        ...
                        IF RecItemAppEntry.FINDFIRST THEN BEGIN
                            ...
                            IF RecItemAppEntry1.FINDFIRST THEN BEGIN
                                ...
                                IF RecItemAppEntry2.FINDFIRST THEN
                                    // MESSAGE('1');
                                    ...
                                    IF RecItemAppEntry2.FINDFIRST THEN BEGIN
                                        ...
                                        ELSE BEGIN
                                            ...
                                            IF RecItemAppEntry3.FINDFIRST THEN BEGIN
                                                ...
                                                IF RecItemAppEntry4.FINDFIRST THEN
    ...
    begin
        ...
        // commented by CCIT AN 04092023 ++ col. visible to evry user
