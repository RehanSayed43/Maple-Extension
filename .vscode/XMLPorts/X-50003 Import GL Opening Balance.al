xmlport 50003 "Import G/L Opening Balance"
{
    Format = VariableText;
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                fieldelement(GenJournalLine_Cur_code; "Gen. Journal Line"."Currency Code")
                {
                }
                ...
                fieldelement(GenJournalLine_Curr_Factor; "Gen. Journal Line"."Currency Factor")
                {
                }
