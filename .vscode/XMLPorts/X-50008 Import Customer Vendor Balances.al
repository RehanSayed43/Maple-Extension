xmlport 50008 "Import CustomerVendor Balances"
{
    Format = VariableText;
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                fieldelement(GenJournalLine_Branch; "Gen. Journal Line"."Shortcut Dimension 1 Code")
                {
                }
                fieldelement(GenJournalLine_Vertical; "Gen. Journal Line"."Shortcut Dimension 2 Code")
                {
                }
            }
