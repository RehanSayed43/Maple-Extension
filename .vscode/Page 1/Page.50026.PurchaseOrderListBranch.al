page 50026 "Purchase Order List Branch"
{
    Caption = 'Purchase Orders';
    CardPageID = "Purchase Order Branch";
    DeleteAllowed = false;
    //Editable = false;
    UsageCategory = Lists;
    ApplicationArea = all;
        ...
        area(content)
        {
            repeater(Repeater)
            {
                ...
                field("Shortcut Dimension 1 Code"; Rec."Shortcut Dimension 1 Code")
                {
                    ...
                    begin
                        // DimMgt.LookupDimValueCodeNoUpdate(1);//tk
                    end;
                }
                field("Shortcut Dimension 2 Code"; Rec."Shortcut Dimension 2 Code")
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    begin
                        // DimMgt.LookupDimValueCodeNoUpdate(2);//tk
                    end;
                }
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Cancel Approval Re&quest")
                {
                    ...
                    begin
                        //tk //IF ApprovalMgt.CancelPurchaseApprovalRequest(Rec,TRUE,TRUE) THEN;
                    end;
                }
