page 50033 "Purchase Order Subform Buyback"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = false;
    ...
    layout
    {
        area(content)
        {
            repeater(Repeater)
            {
                ...
                field("Retail Buyback Ref. No."; Rec."Retail Buyback Ref. No.")
                {
                    Visible = false;
                    ApplicationArea = All;
                }
                ...
                field("No."; Rec."No.")
                {
                    ...
                    begin
                        ...
                        //  UpdateSalesOrderTotalAmt("Retail Buyback Ref. No.",0,xRec."Direct Unit Cost");
                        //  WBU.RefreshPage();
                        //END;
                    end;
                }
                ...
                field("Direct Unit Cost"; Rec."Direct Unit Cost")
                {
                    ...
                    begin
                        ...
                        IF "Direct Unit Cost" <> 0 THEN BEGIN
                          //WBU.RefreshPage();
                          UpdateSalesOrderTotalAmt("Retail Buyback Ref. No.",);
                          WBU.RefreshPage();
                        END;
                        */
                        Rec.UpdateSalesOrderTotalAmt(Rec."Retail Buyback Ref. No.", Rec."Direct Unit Cost", xRec."Direct Unit Cost");
                        IF GUIALLOWED THEN
                            WBU.RefreshPage();
                ...
                field("Line Amount"; Rec."Line Amount")
                {
                    ...
                    trigger OnValidate()
                    begin
                        // UpdateSalesOrderTotalAmt("Retail Buyback Ref. No.","Line Amount",xRec."Line Amount");
                        //  WBU.RefreshPage();
                    end;
                }
                //tk++
    ...
    begin
        IF (Rec.Quantity <> 0) AND Rec.ItemExists(Rec."No.") THEN BEGIN
            Rec.UpdateSalesOrderTotalAmt(Rec."Retail Buyback Ref. No.", 0, Rec."Direct Unit Cost");
            COMMIT;
    ...
    begin
        ...
        //"Document No." := GetRetailPurchOrderNo(SalesOrderNo);
        Rec.Type := Rec.Type::Item;
        Rec."Retail Buyback Ref. No." := Rec.GetRetailSalesOrderNo(Rec);
    ...
    trigger OnOpenPage()
    begin
        //SETFILTER("Retail Buyback Ref. No.",'%1',SalesOrderNo);
    ...
    procedure SetSalesFilter(SalesHeader: Record 36)
    begin
        SalesOrderNo := SalesHeader."No.";
        MESSAGE('Sales Order No %1', SalesOrderNo);
    end;
}
