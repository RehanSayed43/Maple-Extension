page 50078 "Cashier Retail Others"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Advnce Receipt Voucher")
            {
                Caption = 'Advnce Receipt Voucher';
                Image = Print;
                Promoted = true;
        ...
        area(sections)
        {
            group("Posted Documents")
            {
                ...
                action("Posted Sales Invoices Items1")
                {
