codeunit 50034 "Export Data Return"
{
    ...
    var
        ...
        ExportDailySalesData: XMLport 50037;
        FileName: Text;
        SalesData1: Text;
    begin
    ...
    begin
        ...
        IF SalesInvoiceHeader.FINDSET THEN
            //SalesXMLFile.CREATE(TEMPORARYPATH + 'SalesReturn.xml');
